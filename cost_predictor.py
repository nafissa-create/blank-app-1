...
length_x = st.slider ('Length of the diamond', 0.1, 50.0, step=0.1)
width_y = st.slider ('width of the diamond', 0.1, 45.0, step=0.1)
...
encoded_input = encoded_input.reindex(columns= model_columns, fillna=0)
